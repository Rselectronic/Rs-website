            ...
            <Accordion multiple className="space-y-0">
              {category.items.map((item, i) => (
                <AccordionItem
                  ...
                  className="border-2 border-[var(--foreground)] -mt-[2px] first:mt-0 px-6 data-[state=open]:bg-[var(--muted)]"
                >
                  <AccordionTrigger className="text-left font-display text-base font-medium py-5 hover:no-underline">
                    {item.q}
                  </AccordionTrigger>
