...
export function Quality() {
  ...
  const qualityPoints = [
    { icon: Shield, title: t('services.quality.ipc2.title'), body: t('services.quality.ipc2.body') },
    { icon: Award, title: t('services.quality.ipc3.title'), body: t('services.quality.ipc3.body') },
    { icon: TrendingUp, title: t('services.quality.improvement.title'), body: t('services.quality.improvement.body') },
    { icon: FileCheck, title: t('services.quality.iso.title'), body: t('services.quality.iso.body') },
  ];
      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="font-mono text-[10px] uppercase tracking-widest text-[#2563EB]">
            {t('services.quality.label')}
          </span>
        </div>
        <h2 className="font-display text-4xl md:text-5xl font-bold tracking-tight text-[#0F172A] mb-16">
          {t('services.quality.title1')} <span className="italic font-normal">{t('services.quality.title2')}</span>
        </h2>
